...
class ExpanderPage extends ScrollablePage {
  ...
  List<Widget> buildScrollable(BuildContext context) {
    ...
    return [
      const Text(
        'The Expander has a header and can expand to show a body with more content. Use an Expander when some content is only relevant some of the time (for fluent_ui_demo to read more information or access additional options for an item).',
      ),
